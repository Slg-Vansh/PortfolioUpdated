...
const StarBackground = () => {
  ...
  useEffect(() => {
    ...
    const spawnShootingStars = () => {
      ...
      shootTimeout = window.setTimeout(spawnShootingStars, 3000 + Math.random() * 2000);
    };

    shootTimeout = window.setTimeout(spawnShootingStars, 1200);
    ...
    const animate = () => {
      ...
      shootingStars.forEach((star, index) => {
        ...
        const tailX = star.x - star.dx * 6;
        const tailY = star.y - star.dy * 6;
    ...
    return () => {
      ...
      if (shootTimeout) window.clearTimeout(shootTimeout);
...
export default function Portfolio() {
  ...
  return (
    <div className="relative text-white font-sans min-h-screen z-10">
      ...
      >
        <motion.h1 variants={heroItemVariants} className="text-7xl font-bold">
          VANSH
        </motion.h1>
        <motion.p variants={heroItemVariants} className="text-gray-400 mt-4">
          Automation Engineer | RPA Developer | AI Automation
        </motion.p>
        <motion.p variants={heroItemVariants} className="text-gray-400 mt-4 max-w-2xl">
